...
public class BallControl extends JPanel {
	...
	private JButton jbtSuspendResume = new JButton("Suspend");
	...
	public BallControl() {
		...
		// Register listeners
		jbtSuspendResume.addActionListener(new Listener());
	...
	class Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == jbtSuspendResume) {
				if(jbtSuspendResume.getText()=="Suspend") {
					ballPanel.suspend();
					jbtSuspendResume.setText("Resume");
				}else {

					ballPanel.resume();
					jbtSuspendResume.setText("Suspend");
				}	
